...
//..........................特殊图像的提前判断............................//
  ...
  if((!Left_Continuous_Flag) && (!Right_Continuous_Flag) &&((Left_Lost_Flag && (Left_Lost_Start-Left_Lost_End)>40 )||(Right_Lost_Flag &&(Right_Lost_Start-Right_Lost_End)>40)))Cross_Flag=1;
  if((Left_Lost_Flag && (Left_Lost_Start-Left_Lost_End)>40 )&&(Right_Lost_Flag &&(Right_Lost_Start-Right_Lost_End)>40))Cross_Flag=1;
