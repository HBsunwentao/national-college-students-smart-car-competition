...
//..........................特殊图像的提前判断............................//
 ...
 for(i=BOTTOM;i>lSum2+3;i--)
 {
  ...
  if(Left_Uncontinuous_Flag && Right_Uncontinuous_Flag &&(Left_Lost_Flag || Right_Lost_Flag) )Cross_Flag=1;
   if((!Left_Continuous_Flag) && (!Right_Continuous_Flag) &&((Left_Lost_Flag && (Left_Lost_Start-Left_Lost_End)>20 )||(Right_Lost_Flag &&(Right_Lost_Start-Right_Lost_End)>20)))Cross_Flag=1;
